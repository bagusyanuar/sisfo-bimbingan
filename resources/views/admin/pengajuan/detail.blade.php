...
@section('content')
    ...
    <div class="container-fluid pt-3">
        <div class="d-flex align-items-center justify-content-between mb-3">
            <p class="font-weight-bold mb-0" style="font-size: 20px">Halaman Detail Pengajuan Laporan Siswa</p>
            <ol class="breadcrumb breadcrumb-transparent mb-0">
                <li class="breadcrumb-item">
                    <a href="/dashboard">Dashboard</a>
                </li>
                <li class="breadcrumb-item">
                    <a href="/pengajuan-laporan">Pengajuan Laporan Siswa</a>
                </li>
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-3">
                                    <span class="font-weight-bold">Judul Laporan</span>
                                </div>
                                <div class="col-lg-9 col-md-3">
                                    <span class="font-weight-bold">: {{ $data->judul }}</span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-3 col-md-3">
                                    <span class="font-weight-bold">File Lampiran</span>
                                </div>
                                <div class="col-lg-9 col-md-3">
                                    <span class="font-weight-bold">:</span>
                                    <a href="{{ asset('/file').'/'.$data->file }}" target="_blank">{{ $data->file }}</a>
                                </div>
                            </div>
                            <form method="post" action="/pengajuan-laporan/patch">
                                @csrf
